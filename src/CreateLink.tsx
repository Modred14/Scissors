...
const CreateLink: React.FC = () => {
  ...
  const hasFullStop = longUrl.includes(".");
  const customHasFullStop = customLink.includes(".");
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log("newLink with QR code:", newLink);
    ...
    try {
      setLoading(true);
      const response = await axios.post("http://localhost:3000/links", newLink);
        ...
        <form onSubmit={handleSubmit}>
          <main className="px-100 main">
            <div className="pt-20">
              ...
              <label className="text-md pt-3 font-bold" htmlFor="longUrl">
                Destination
              </label>
              ...
              <input
                ...
                className={`peer h-12 mt-1 block w-full px-3 py-2 bg-white border ${
                  !hasFullStop && longUrl && isSubmitted
            ...
            "
              ...
              <input
                ...
                className={`peer h-12 mt-1 block w-full px-3 py-2 bg-white border ${
                  !customHasFullStop && customLink && isSubmitted
                    ? "border-pink-500 text-pink-600"
                    : "border-slate-300"
                } rounded-sm text-m shadow-sm placeholder-slate-400
                  focus:outline-none  focus:ring-gray-400 focus:ring-1 
              ...
              <div className="grid grid-flow-col pt-8 w-44">
              ...
              {isPreviewVisible && (
                <div className="shadow flex-qr p-5 max-w-4xl grid-qrcode bg-gray-300 ">
                  ...
                  <div className="bg-white qr-width p-7 shadow mt-6 sm:m-3">
                    ...
                    <div className="pp bg-white  w-auto p-5 justify-center items-center justify-self-center shadow outline m-3 outline-1">
                      <div ref={qrRef}>
                        <QRCode
